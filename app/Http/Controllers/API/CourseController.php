...
class CourseController extends Controller
{
    ...
    #[Get(
        ...
        tags: ['Course'],
        parameters: [
            new Parameter(name: 'id', description: 'Course id', in: 'query', required: true, schema: new Schema(type: 'integer'))
        ],
        responses: [
            new Response(response: 200, description: 'Everything is fine'),
            new Response(response: 404, description: 'Page not found'),
    ...
    #[Delete(
        ...
        tags: ['Course'],
        parameters: [
            new Parameter(name: 'id', description: 'Customer id', in: 'query', required: true, schema: new Schema(type: 'integer'))
        ],
        responses: [
